...
def create_chat():
    ...
    try:
        ...
        print(f"Error summarizing search results: {e}")
        search_summary = "Error summarizing search results, please try again with the same or different query."
...
def get_response():
    ...
    try:
        ...
        response = "Error getting AI response, please try again with the same or different message."
